...
$$\iiint_V (\nabla \cdot \mathbf{F}) \, dV = \oint\kern-8pt\oint_S \mathbf{F} \cdot d\mathbf{S}$$
...
$$\Phi_E = \oint\kern-8pt\oint_{S_0} \mathbf{E} \cdot d\mathbf{S} = \oint\kern-8pt\oint_{S_0} E \, dS = \frac{q}{4\pi\varepsilon_0 r^2} \cdot 4\pi r^2 = \frac{q}{\varepsilon_0}$$
...
$$\oint\kern-8pt\oint_S \mathbf{E} \cdot d\mathbf{S} = \frac{Q_{\text{enc}}}{\varepsilon_0} = \frac{1}{\varepsilon_0} \iiint_V \rho \, dV$$
...
1. **高斯定律（电场）**：
   $$\oint\kern-8pt\oint_S \mathbf{E} \cdot d\mathbf{S} = \frac{Q_{\text{enc}}}{\varepsilon_0}$$

2. **高斯磁定律**：
   $$\oint\kern-8pt\oint_S \mathbf{B} \cdot d\mathbf{S} = 0$$
