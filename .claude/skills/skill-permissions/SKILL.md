...
description: Skill permission analysis, one-time authorization, analyze skill permissions, batch authorization. Use when user asks to analyze permissions, authorize skills, or check skill permissions.
---
